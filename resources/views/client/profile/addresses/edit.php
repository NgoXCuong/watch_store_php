            ...
            <div class="card border-0 shadow-sm rounded-0 mb-5">
                <div class="card-header bg-white border-bottom py-4 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold letter-spacing-2" style="font-family: var(--font-heading);">
                        <i class="fas fa-edit me-2 text-warning"></i>Cập nhật địa chỉ
                    </h5>
                ...
                <div class="card-body p-4 p-lg-5">
                    ...
                    <form action="<?php echo BASE_URL; ?>/profile/addresses/update/<?php echo $data['address']['id']; ?>" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control rounded-0 <?php echo isset($data['errors']['recipient_name']) ? 'is-invalid' : ''; ?>" 
                                           ...
                                           value="<?php echo htmlspecialchars($data['old_input']['recipient_name'] ?? $data['address']['recipient_name']); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control rounded-0 <?php echo isset($data['errors']['recipient_phone']) ? 'is-invalid' : ''; ?>" 
                                           ...
                                           value="<?php echo htmlspecialchars($data['old_input']['recipient_phone'] ?? $data['address']['recipient_phone']); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control rounded-0 <?php echo isset($data['errors']['city']) ? 'is-invalid' : ''; ?>" 
                                           ...
                                           value="<?php echo htmlspecialchars($data['old_input']['city'] ?? $data['address']['city']); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control rounded-0 <?php echo isset($data['errors']['district']) ? 'is-invalid' : ''; ?>" 
                                           ...
                                           value="<?php echo htmlspecialchars($data['old_input']['district'] ?? $data['address']['district']); ?>">
                        ...
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control rounded-0 <?php echo isset($data['errors']['address_line']) ? 'is-invalid' : ''; ?>" 
                                   ...
                                   value="<?php echo htmlspecialchars($data['old_input']['address_line'] ?? $data['address']['address_line']); ?>">
                        ...
                        <div class="form-check mb-4">
                            <?php 
                                $isChecked = isset($data['old_input']['is_default']) ? true : ($data['address']['is_default'] == 1);
                            ?>
                            <input class="form-check-input" type="checkbox" id="is_default" name="is_default" value="1" <?php echo $isChecked ? 'checked' : ''; ?> <?php echo ($data['address']['is_default'] == 1) ? 'disabled' : ''; ?>>
                            <label class="form-check-label" for="is_default">
                                Đặt làm địa chỉ mặc định <?php echo ($data['address']['is_default'] == 1) ? '<span class="text-muted small">(Đây đang là địa chỉ mặc định)</span>' : ''; ?>
                            </label>
                            <?php if ($data['address']['is_default'] == 1): ?>
