<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo BASE_URL; ?>/admin/products/update/<?php echo $product['id']; ?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            <!-- Thông tin cơ bản -->
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control <?php echo isset($errors['name']) ? 'is-invalid' : ''; ?>"
                                                   id="name" name="name" value="<?php echo htmlspecialchars($old_input['name'] ?? $product['name']); ?>" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control <?php echo isset($errors['slug']) ? 'is-invalid' : ''; ?>"
                                                   id="slug" name="slug" value="<?php echo htmlspecialchars($old_input['slug'] ?? $product['slug']); ?>" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="4"><?php echo htmlspecialchars($old_input['description'] ?? $product['description']); ?></textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control <?php echo isset($errors['price']) ? 'is-invalid' : ''; ?>"
                                                   id="price" name="price" value="<?php echo htmlspecialchars($old_input['price'] ?? $product['price']); ?>" min="0" step="0.01" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="old_price" name="old_price"
                                                   value="<?php echo htmlspecialchars($old_input['old_price'] ?? $product['old_price']); ?>" min="0" step="0.01">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="stock" name="stock"
                                                   value="<?php echo htmlspecialchars($old_input['stock'] ?? $product['stock']); ?>" min="0">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-select <?php echo isset($errors['brand_id']) ? 'is-invalid' : ''; ?>" id="brand_id" name="brand_id" required>
                                                ...
                                                <?php foreach ($brands as $brand): ?>
                                                    <option value="<?php echo $brand['id']; ?>"
                                                            <?php echo (isset($old_input['brand_id']) ? $old_input['brand_id'] : $product['brand_id']) == $brand['id'] ? 'selected' : ''; ?>>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Hidden input for specifications JSON -->
                                    <input type="hidden" id="specifications" name="specifications" value="<?php echo htmlspecialchars($old_input['specifications'] ?? $product['specifications']); ?>">

                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="image_file" class="form-label">Hình ảnh chính mới (tùy chọn)</label>
                                            <input type="file" class="form-control" id="image_file" name="image_file"
                                                   accept="image/*" onchange="previewMainImage(event)">
                                            <div class="form-text">Chỉ chọn file nếu muốn thay đổi hình ảnh chính</div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="gallery_files" class="form-label">Thư viện ảnh mới (tùy chọn)</label>
                                            ...
                                            <div class="form-text">Chọn nhiều file để thay thế thư viện ảnh (tối đa 5 ảnh)</div>
                                        </div>
                                    </div>

                                    <!-- Hidden inputs for URLs -->
                                    <input type="hidden" id="image_url" name="image_url" value="<?php echo htmlspecialchars($old_input['image_url'] ?? $product['image_url']); ?>">
                                    <input type="hidden" id="gallery_urls" name="gallery_urls" value="<?php echo htmlspecialchars($old_input['gallery_urls'] ?? $product['gallery_urls']); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="status" name="status">
                                            <option value="active" <?php echo (isset($old_input['status']) ? $old_input['status'] : $product['status']) === 'active' ? 'selected' : ''; ?>>Hoạt động</option>
                                            <option value="inactive" <?php echo (isset($old_input['status']) ? $old_input['status'] : $product['status']) === 'inactive' ? 'selected' : ''; ?>>Không hoạt động</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1"
                                                   <?php echo (isset($old_input['is_featured']) ? $old_input['is_featured'] : $product['is_featured']) ? 'checked' : ''; ?>>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5 class="mb-0"><i class="fas fa-info me-2"></i>Thông tin sản phẩm</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div><?php echo $product['views']; ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <div id="image-preview" class="mb-3">
                                        <?php
                                        $currentImageUrl = $old_input['image_url'] ?? $product['image_url'];
                                        if ($currentImageUrl):
                                        ?>
                                            <img id="preview-img" src="<?php echo htmlspecialchars($currentImageUrl); ?>"
                                        ...
                                        <?php endif; ?>
                                        <div id="no-image" class="text-muted" style="<?php echo $currentImageUrl ? 'display: none;' : ''; ?>">
                                    ...
                                    <?php
                                    $currentGallery = $old_input['gallery_urls'] ?? $product['gallery_urls'];
                                    if ($currentGallery):
                                        $galleryImages = json_decode($currentGallery, true);
                                        ...
                                        <div class="gallery-preview">
                                            <?php foreach ($galleryImages as $index => $imageUrl): ?>
                                                <div class="gallery-img-container">
                                                    <img src="<?php echo htmlspecialchars($imageUrl); ?>" alt="Gallery <?php echo $index + 1; ?>" class="gallery-img">
                                                </div>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
...
function previewMainImage(event) {
    ...
    if (file) {
        ...
        // If no new file selected, show original image
...
function previewGalleryImages(event) {
    ...
    if (galleryPreview) {
        ...
        // Create gallery preview container if it doesn't exist
    ...
    if (galleryContainer && files.length > 0) {
...
document.querySelector('form').addEventListener('submit', function(e) {
    ...
    // Load preview on page load - ensure images are visible
    const imageUrl = document.getElementById('image_url').value;
    const previewImg = document.getElementById('preview-img');
    const noImage = document.getElementById('no-image');
    ...
    if (imageUrl && imageUrl.trim() !== '') {
        previewImg.style.display = 'block';
        noImage.style.display = 'none';
        console.log('Loading existing image:', imageUrl);
    } else {
        previewImg.style.display = 'none';
        noImage.style.display = 'block';
    ...
    console.log('Page loaded with image_url:', imageUrl);
