<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="fas fa-plus-circle me-2"></i>Thêm voucher mới</h1>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo BASE_URL; ?>/admin/vouchers/store" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control text-uppercase <?php echo isset($data['errors']['code']) ? 'is-invalid' : ''; ?>"
                                       id="code" name="code"
                                       value="<?php echo htmlspecialchars($data['old_input']['code'] ?? ''); ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control <?php echo isset($data['errors']['description']) ? 'is-invalid' : ''; ?>"
                                          id="description" name="description" rows="3" required><?php echo htmlspecialchars($data['old_input']['description'] ?? ''); ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="discount_type" name="discount_type" required onchange="toggleDiscountFields()">
                                    <option value="fixed" <?php echo ($data['old_input']['discount_type'] ?? '') === 'fixed' ? 'selected' : ''; ?>>Giảm giá cố định (VNĐ)</option>
                                    <option value="percent" <?php echo ($data['old_input']['discount_type'] ?? '') === 'percent' ? 'selected' : ''; ?>>Giảm giá theo phần trăm (%)</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?php echo isset($data['errors']['discount_value']) ? 'is-invalid' : ''; ?>"
                                       ...
                                       value="<?php echo htmlspecialchars($data['old_input']['discount_value'] ?? ''); ?>" required>
                            ...
                            <div class="mb-3" id="max_discount_container" style="display: none;">
                                ...
                                <input type="number" class="form-control" id="max_discount_amount" name="max_discount_amount" min="0" step="0.01"
                                       value="<?php echo htmlspecialchars($data['old_input']['max_discount_amount'] ?? ''); ?>">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?php echo isset($data['errors']['min_order_value']) ? 'is-invalid' : ''; ?>"
                                       ...
                                       value="<?php echo htmlspecialchars($data['old_input']['min_order_value'] ?? ''); ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?php echo isset($data['errors']['usage_limit']) ? 'is-invalid' : ''; ?>"
                                       ...
                                       value="<?php echo htmlspecialchars($data['old_input']['usage_limit'] ?? ''); ?>" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" id="start_date" name="start_date"
                                               value="<?php echo htmlspecialchars($data['old_input']['start_date'] ?? ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control <?php echo isset($data['errors']['end_date']) ? 'is-invalid' : ''; ?>"
                                               ...
                                               value="<?php echo htmlspecialchars($data['old_input']['end_date'] ?? ''); ?>">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                           <?php echo ($data['old_input']['is_active'] ?? 1) ? 'checked' : ''; ?>>
