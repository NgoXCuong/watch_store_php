<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="fas fa-edit me-2"></i>Chỉnh sửa thương hiệu</h1>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo BASE_URL; ?>/admin/brands/update/<?php echo $brand['id']; ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?php echo isset($errors['name']) ? 'is-invalid' : ''; ?>"
                                       id="name" name="name"
                                       value="<?php echo htmlspecialchars($old_input['name'] ?? $brand['name']); ?>"
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?php echo isset($errors['slug']) ? 'is-invalid' : ''; ?>"
                                       id="slug" name="slug"
                                       value="<?php echo htmlspecialchars($old_input['slug'] ?? $brand['slug']); ?>"
                                       required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Chỉ chọn file nếu muốn thay đổi logo. Để trống để giữ logo hiện tại.</div>
                    ...
                    <input type="hidden" id="logo_url" name="logo_url" value="<?php echo htmlspecialchars($old_input['logo_url'] ?? $brand['logo_url']); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="border rounded p-3 text-center" style="min-height: 120px;">
                            <?php
                            $currentLogoUrl = $old_input['logo_url'] ?? $brand['logo_url'];
                            if ($currentLogoUrl):
                            ?>
                                <img id="logo-preview-img" src="<?php echo htmlspecialchars($currentLogoUrl); ?>"
                                     alt="Logo Preview" class="logo-preview">
                            <?php else: ?>
                                <img id="logo-preview-img" src="" alt="Logo Preview" class="logo-preview" style="display: none;">
                            <?php endif; ?>
                            <div id="no-logo" class="text-muted" style="<?php echo $currentLogoUrl ? 'display: none;' : ''; ?>">
...
function previewLogo(event) {
    ...
    if (file) {
        ...
        // If no new file selected, show original logo
